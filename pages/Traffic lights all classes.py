...
df_wide_2223 = pd.read_csv('data/22_23/traffic_lights/wide_traffic_lights_2223.csv')
df_long_2223 = pd.read_csv('data/22_23/traffic_lights/long_traffic_lights_2223.csv')
